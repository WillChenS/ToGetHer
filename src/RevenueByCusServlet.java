...
import ListOfDateServlet2.SaleReportInfo;

/**
 * Servlet implementation class RevenueByCusServlet
 */
@WebServlet("/RevenueByCusServlet")
public class RevenueByCusServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RevenueByCusServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.setAttribute("RBC", listing);
			getServletContext().getRequestDispatcher("/RBC.jsp").forward(request, response);
